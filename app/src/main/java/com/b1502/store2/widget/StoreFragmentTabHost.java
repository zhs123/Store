 ...
 *      complete}
 */
public class StoreFragmentTabHost extends TabHost
    ...
    private StoreFragmentTabHost.TabInfo mLastTab;
    ...
    static class SavedState extends BaseSavedState {
        ...
        public static final Creator<SavedState> CREATOR
            ...
            @Override
            public StoreFragmentTabHost.SavedState createFromParcel(Parcel in) {
                return new StoreFragmentTabHost.SavedState(in);
            }

            @Override
            public StoreFragmentTabHost.SavedState[] newArray(int size) {
                return new StoreFragmentTabHost.SavedState[size];
            }
        };
    }

    public StoreFragmentTabHost(Context context) {
    ...
    public StoreFragmentTabHost(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void addTab(@NonNull TabSpec tabSpec, @NonNull Class<?> clss,
        ...
        tabSpec.setContent(new StoreFragmentTabHost.DummyTabFactory(mContext));

        final String tag = tabSpec.getTag();
        final StoreFragmentTabHost.TabInfo info = new StoreFragmentTabHost.TabInfo(tag, clss, args);
    ...
    protected void onAttachedToWindow() {
        ...
        for (int i = 0, count = mTabs.size(); i < count; i++) {
            final StoreFragmentTabHost.TabInfo tab = mTabs.get(i);
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        StoreFragmentTabHost.SavedState ss = new StoreFragmentTabHost.SavedState(superState);
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (!(state instanceof StoreFragmentTabHost.SavedState)) {
            super.onRestoreInstanceState(state);
            return;
        }
        StoreFragmentTabHost.SavedState ss = (StoreFragmentTabHost.SavedState) state;
    ...
    private FragmentTransaction doTabChanged(@Nullable String tag,
        ...
        final StoreFragmentTabHost.TabInfo newTab = getTabInfoForTag(tag);
        if (mLastTab != newTab) {
            if (ft == null) {
                ft = mFragmentManager.beginTransaction();
            }
    ...
    @Nullable
    private StoreFragmentTabHost.TabInfo getTabInfoForTag(String tabId) {
        for (int i = 0, count = mTabs.size(); i < count; i++) {
            final StoreFragmentTabHost.TabInfo tab = mTabs.get(i);
