...
public class StoreParams extends RequestParams {
    ...
    public StoreParams(String uri, String params, String newsId) {
        super(UrlUtil.getAPIUrl(uri, params, newsId));
        init();
    }

    public StoreParams(String uri, String id, int startRowIndex) {
        super(UrlUtil.getAPIUrl(uri, id, startRowIndex));
        init();
    }
